 ...
 * and minor number.
 *
 * Used when comparing against return value of
 * hw_version().  For example to check if this is at least version 1.2:
 *   ChipInfoGetChipVersion(&version);
...
/**
 * Maximum length of a chip id string.
 *
 * Can be used by clients when
 * declaring space for ChipInfoGetChipIdString.
 */
#define CHIPINFO_MAX_ID_LENGTH  32

/**
 * Maximum length of a processor name string.
 *
 * Can be used by
 ...
 * These macros are deprecated, and haven't meant anything for several
 * years. New development should only use CHIPINFO_MODEM_SUPPORTED or
 * CHIPINFO_MODEM_UNKNOWN.
 *
 * See ChipInfoGetModemSupport for more information.
 */
...
typedef enum {
  ...
  CHIPINFO_ID_QDRU_LASSEN                 = CHIPINFO_ID_QRU_LASSEN,
  ...
  CHIPINFO_ID_QCS_PINNACLES               = 716,
  CHIPINFO_ID_QCS_KUNO                    = 717,
  CHIPINFO_ID_SCP_GLYMUR_RESERVED         = 718,
  CHIPINFO_ID_SCP_GLYMUR_AS_KALAMBO6C     = 719,
  CHIPINFO_ID_QMB_PALOMA                  = 720,
 ...
 * Chip Family type.
 *
 * The family type of the chip we are running on.
 * Each family may include multiple chip ids.
 *
 * A family contains a base device and all of its revisions and variants.
 *  e.g. CHIPINFO_FAMILY_8996 is used for MSM8996 v1, 2, 3, and APQ8096.
 * It bears no connection to the underlying architecture family.
 */
typedef enum {
...
/**
 ...
 Unique within each ChipInfoFamily.
 */
...
typedef enum {
  ...
  CHIPINFO_FOUNDRYID_SAMSUNG_S5 = 7,
 ...
 *
 * See ChipInfoGetSKU for more details.
 */
typedef enum {
  CHIPINFO_FEATURE_CODE_UNKNOWN = 0,

  CHIPINFO_FEATURE_CODE_AA = 0x01,
  CHIPINFO_FEATURE_CODE_AB = 0x02,
  CHIPINFO_FEATURE_CODE_AC = 0x03,
  CHIPINFO_FEATURE_CODE_AD = 0x04,
  CHIPINFO_FEATURE_CODE_AE = 0x05,
  CHIPINFO_FEATURE_CODE_AF = 0x06,
  CHIPINFO_FEATURE_CODE_AG = 0x07,
  CHIPINFO_FEATURE_CODE_AH = 0x08,
  // Reserved for future use

  CHIPINFO_FEATURE_CODE_Y0 = 0xf1,
  CHIPINFO_FEATURE_CODE_Y1 = 0xf2,
  CHIPINFO_FEATURE_CODE_Y2 = 0xf3,
  CHIPINFO_FEATURE_CODE_Y3 = 0xf4,
  CHIPINFO_FEATURE_CODE_Y4 = 0xf5,
  CHIPINFO_FEATURE_CODE_Y5 = 0xf6,
  CHIPINFO_FEATURE_CODE_Y6 = 0xf7,
  CHIPINFO_FEATURE_CODE_Y7 = 0xf8,
  CHIPINFO_FEATURE_CODE_Y8 = 0xf9,
  CHIPINFO_FEATURE_CODE_Y9 = 0xfa,
  CHIPINFO_FEATURE_CODE_YA = 0xfb,
  CHIPINFO_FEATURE_CODE_YB = 0xfc,
  CHIPINFO_FEATURE_CODE_YC = 0xfd,
  CHIPINFO_FEATURE_CODE_YD = 0xfe,
  CHIPINFO_FEATURE_CODE_YE = 0xff,
  CHIPINFO_FEATURE_CODE_YF = 0x100,
  // Reserved for future use

  CHIPINFO_FEATURE_CODE_32BITS = 0x7fffffff
} ChipInfoFeatureCodeType;

/**
 * P_CODE logical mappings.
 *
 * See ChipInfoGetSKU for more details.
 */
typedef enum {
  CHIPINFO_P_CODE_UNKNOWN = 0,

  CHIPINFO_P_CODE_0 = 0x1,
  CHIPINFO_P_CODE_1 = 0x2,
  CHIPINFO_P_CODE_2 = 0x3,
  CHIPINFO_P_CODE_3 = 0x4,
  CHIPINFO_P_CODE_4 = 0x5,
  CHIPINFO_P_CODE_5 = 0x6,
  CHIPINFO_P_CODE_6 = 0x7,
  CHIPINFO_P_CODE_7 = 0x8,
  // Reserved for future use

  CHIPINFO_P_CODE_32BITS = 0x7fffffff
} ChipInfoPCodeType;
 ...
 */
typedef struct {
  ChipInfoFeatureCodeType    eFeatureCode;
  ChipInfoPCodeType          ePCode;
} ChipInfoSKUType;
