...
*/
typedef struct PlatformInfoSMemPMICType {
 ...
 */
typedef struct PlatformInfoPartInfoType {
  UINT16    ePart;
  UINT8     nInstance;
  UINT8     bDisabled;
  UINT32    nDisabledFeatures;
...
typedef struct {
  ...
  CHAR8                       aBuildId[PLATFORMINFO_SMEM_BUILD_ID_LENGTH];
  /**< Build ID. */
  UINT32                      nRawChipId;             /**< Raw chip ID. */
  UINT32                      nRawChipVersion;        /**< Raw chip version. */
  PlatformInfoPlatformType    ePlatformType;          /**< Platform type. */
  ...
  PlatformInfoSMemPMICType    aPMICInfo[PLATFORMINFO_SMEM_MAX_PMIC_DEVICES];
  ...
  CHAR8                       szChipIdStr[PLATFORMINFO_SMEM_MAX_CHIP_ID_LENGTH]; /**< Chip name */
  UINT32                      nNumClusters;                                      /**< Number of clusters used by ChipInfo_GetDisabledCPUs API */
  UINT32                      nClusterArrayOffset;                               /**< Offset from base of structure to
                                                             UINT32 array of disabled CPU clusters. Used by ChipInfo_GetDisabledCPUs API*/
  UINT32                      nNumParts;                                         /**< Number of parts supported by ChipInfo_GetDisabledFeatures API*/
  UINT32                      nDisabledFeaturesArrayOffset;                      /**< Offset from base of structure to
                                                                   UINT32 array of disabled parts */
  UINT32                      nModemSupported;                                   /**< 0 if not supported, nonzero if supported */
  UINT32                      eFeatureCode;                                      /**< Feature Code  enum for this device */
  UINT32                      ePCode;                                            /**< PCode for this device */
  UINT32                      nPartNameMapOffset;                                /**< Offset of the part name
                                                              strings for the current chip,
                                                              from the base of socinfo. */
  UINT32                      nNumPartNameMappings;                              /**< Number of part name strings. */
  UINT32                      nOEMVariantID;                                     /**< OEM Variant ID */
  UINT32                      nNumKVPS;                                          /**< Number of KVPS */
  UINT32                      nKVPSOffset;                                       /**< Offset of the KVPS */
  UINT32                      nNumFunctionalClusters;                            /**< Number of clusters with >=1 enabled core */
  UINT32                      nBootCluster;                                      /**< Boot cluster index */
  UINT32                      nBootCore;                                         /**< Boot core index */
  UINT32                      nRawPackageType;                                   /**< Raw package type. */
  UINT32                      nPartialFeaturesArrayOffset;                       /**< Offset from base of this structure to an
                                                                    array of UINT32s indexed by ChipInfoPartType.
                                                                    Each bit corresponds to a component of that part,
                                                                    with 0 = enabled/unknown and 1 = disabled. */
  UINT32                      nCPUCoresArrayOffset;                              /**< Offset from base of structure to
                                                             UINT32 array of no.of CPU cores per cluster for all clusters. Used by ChipInfo_GetNumCPUCores API*/
   ...
   */
  UINT32                      anPartInstancesOffset;

  /*
   * Length of the array at anPartInstancesOffset
   */
  UINT32                      nNumPartInstances;
